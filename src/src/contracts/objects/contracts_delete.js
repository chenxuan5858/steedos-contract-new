...
let receipts_in = await receiptsObj.find({filters:[["_id.contract", "=" , contractId]]});
//let invoice_in = await invoiceObj.find({filters:[[contractId, "=" , _id.contract]]});
//let refund_in = await refundObj.find({filters:[[contractId, "=" , _id.contract]]});
//let event_in = await eventsObj.find({filters:[[contractId, "=" , _id.related_to_contract]]});
